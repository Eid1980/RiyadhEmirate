...
@Component({
  selector: 'app-servie-notification-email-add',
  templateUrl: './servie-notification-email-add.component.html'
})
export class ServieNotificationEmailAddComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.globalService.setAdminTitle('اضافة رسالة بريد الكتروني جديدة');
    this.buildForm();
  ...
  onSubmit() {
    ...
    if (this.createForm.valid) {
      ...
      this.createServieNotificationDto.isSMS = false;
      this.createServieNotificationDto.isEmail = true;
