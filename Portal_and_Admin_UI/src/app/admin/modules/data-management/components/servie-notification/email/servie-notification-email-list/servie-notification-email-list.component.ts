...
@Component({
  selector: 'app-servie-notification-email-list',
  templateUrl: './servie-notification-email-list.component.html'
})
export class ServieNotificationEmailListComponent implements OnInit {
  ...
  ngOnInit() {
    this.globalService.setAdminTitle('اعدادات رسائل البريد الالكتروني');
    this.pageSetting();
  }
  ...
  pageSetting() {
    ...
    this.pageListSettings = {
      PageTitle: 'قائمة رسائل البريد الالكتروني',
      listPermissionCode: '*',
      createButtonLink: '/admin/data-management/servie-notification-email-add',
      createButtonText: 'انشاء رسالة بريد الكتروني جديدة',
      ...
      actions: [
        ...
        {
          title: 'تعديل',
          routerLink: '/admin/data-management/servie-notification-email-edit',
          IsQueryParams: true,
        ...
        {
          title: 'التفاصيل',
          routerLink: '/admin/data-management/servie-notification-email-view',
          IsQueryParams: true,
          buttonclass: ActionButtonClass.View,
