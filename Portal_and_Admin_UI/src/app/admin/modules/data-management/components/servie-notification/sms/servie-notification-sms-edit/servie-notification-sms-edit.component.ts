...
@Component({
  selector: 'app-servie-notification-sms-edit',
  templateUrl: './servie-notification-sms-edit.component.html'
})
export class ServieNotificationSmsEditComponent implements OnInit {
  id: number;
  ...
  ngOnInit(): void {
    this.globalService.setAdminTitle('تعديل الرسالة النصية');
    this.buildForm();
    ...
    if (this.id) {
      ...
      this.globalService.navigate("/admin/data-management/ervie-notification-sms-list");
    }
