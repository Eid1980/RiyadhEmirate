...
@Component({
  selector: 'app-reports-en-list',
  templateUrl: './reports-en-list.component.html'
})
export class ReportsEnListComponent implements OnInit {
  ...
  ngOnInit() {
    this.globalService.setAdminTitle('التقارير الاعلامية انجليزي');
    this.pageSetting();
  }
  ...
  pageSetting() {
    ...
    this.pageListSettings = {
      PageTitle: 'قائمة التقارير الاعلامية انجليزي',
      listPermissionCode: '*',
      createButtonLink: '/admin/data-management/reports-en-add',
      createButtonText: 'انشاء تقرير اعلامي انجليزي جديد',
      ...
      actions: [
        {
          title: 'تعديل',
          routerLink: '/admin/data-management/reports-en-edit',
          IsQueryParams: true,
        ...
        {
          title: 'التفاصيل',
          routerLink: '/admin/data-management/reports-en-view',
          IsQueryParams: true,
