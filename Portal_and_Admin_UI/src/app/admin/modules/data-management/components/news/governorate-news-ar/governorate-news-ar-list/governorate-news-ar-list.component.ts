...
@Component({
  selector: 'app-governorate-news-ar-list',
  templateUrl: './governorate-news-ar-list.component.html'
})
export class GovernorateNewsArListComponent implements OnInit {
  ...
  ngOnInit() {
    this.globalService.setAdminTitle('أخبار المحافظات عربي');
    this.pageSetting();
  }
  ...
  pageSetting() {
    ...
    this.pageListSettings = {
      PageTitle: 'قائمة أخبار المحافظات عربي',
      listPermissionCode: '*',
      createButtonLink: '/admin/data-management/governorate-news-ar-add',
      ...
      actions: [
        {
          title: 'تعديل',
          routerLink: '/admin/data-management/governorate-news-ar-edit',
          IsQueryParams: true,
        ...
        {
          title: 'التفاصيل',
          routerLink: '/admin/data-management/governorate-news-ar-view',
          IsQueryParams: true,
