...
@Component({
  selector: 'app-latest-news-en-comments',
  templateUrl: './latest-news-en-comments.component.html'
})
export class LatestNewsEnCommentsComponent implements OnInit {
  ...
  ngOnInit() {
    this.globalService.setAdminTitle('تعليقات أخر الأخبار انجليزي');
    this.pageSetting();
  }
  ...
  pageSetting() {
    ...
    this.pageListSettings = {
      PageTitle: 'تعليقات أخر الأخبار انجليزي',
      listPermissionCode: '*',
