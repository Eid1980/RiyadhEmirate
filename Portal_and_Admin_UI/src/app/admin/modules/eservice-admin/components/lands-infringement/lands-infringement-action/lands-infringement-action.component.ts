...
@Component({
  selector: 'app-lands-infringement-action',
  templateUrl: './lands-infringement-action.component.html'
})
export class LandsInfringementActionComponent implements OnInit {
  requestId: string;
