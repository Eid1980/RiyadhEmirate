...
@Component({
  selector: 'app-foreigners-realty-owner-action',
  templateUrl: './foreigners-realty-owner-action.component.html'
})
export class ForeignersRealtyOwnerActionComponent implements OnInit {
  requestId: string;
