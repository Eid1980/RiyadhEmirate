...
@Component({
  selector: 'app-electronic-summon-action',
  templateUrl: './electronic-summon-action.component.html'
})
export class ElectronicSummonActionComponent implements OnInit {
  requestId: string;
