...
@Component({
  selector: 'app-treatment-recommendation-action',
  templateUrl: './treatment-recommendation-action.component.html'
})
export class TreatmentRecommendationActionComponent implements OnInit {
  requestId: string;
