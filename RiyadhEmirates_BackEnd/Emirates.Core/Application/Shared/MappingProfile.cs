...
namespace Emirates.Core.Application.Shared
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            #region ServiceStage
            CreateMap<CreateServieNotificationDto, ServieNotification>();
            CreateMap<UpdateServieNotificationDto, ServieNotification>();

            CreateMap<ServieNotification, GetServieNotificationDetailsDto>()
                .ForMember(dest => dest.ServiceName, src => src.MapFrom(m => m.Service.NameAr))
                .ForMember(dest => dest.StageName, src => src.MapFrom(m => m.Stage.NameAr))
                .ForMember(dest => dest.Message, src => src.MapFrom(m => m.ServieNotificationLogs.FirstOrDefault(x => x.EndDate.HasValue == false).Message));
            CreateMap<ServieNotification, GetServieNotificationListDto>()
                .ForMember(dest => dest.ServiceName, src => src.MapFrom(m => m.Service.NameAr))
                .ForMember(dest => dest.StageName, src => src.MapFrom(m => m.Stage.NameAr))
                .ForMember(dest => dest.Message, src => src.MapFrom(m => m.ServieNotificationLogs.FirstOrDefault(x => x.EndDate.HasValue == false).Message));
