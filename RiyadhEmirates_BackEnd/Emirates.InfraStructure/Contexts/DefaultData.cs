...
namespace Emirates.InfraStructure.Contexts
{
    public static class DefaultData
    {
        ...
        public static Stage[] Stages()
        {
            ...
            arrData[0] = new Stage { Id = 1, NameAr = "مسودة", NameEn = "Draft", CanEdit = true, CanAddNew = false, SendNotification = false, IsActive = true, CreatedBy = 1, CreatedDate = new DateTime(2022, 10, 1) };
        ...
        {
            ServieNotificationLog[] arrData = new ServieNotificationLog[6];
            ...
            arrData[2] = new ServieNotificationLog { Id = 3, ServieNotificationId = 3, Message = "عزيزي المستفيد نفيدكم بأنه تم رفض طلبكم رقم (رقم الطلب) ويمكنكم الاطلاع على سبب الرفض من شاشة طلباتي.", CreatedBy = 1, CreatedDate = new DateTime(2022, 10, 1) };
            arrData[3] = new ServieNotificationLog { Id = 4, ServieNotificationId = 4, Message = "عزيزي المستفيد نفيدكم بتقديم طلبكم رقم(رقم الطلب) بنجاح وسيتم اشعاركم في حالة الرد على الطلب.", CreatedBy = 1, CreatedDate = new DateTime(2022, 10, 1) };
            arrData[4] = new ServieNotificationLog { Id = 5, ServieNotificationId = 5, Message = "عزيزي المستفيد نفيدكم بارجاع طلبكم رقم (رقم الطلب) فضلا مراجعة الملاحظات واعادة ارسال الطلب.", CreatedBy = 1, CreatedDate = new DateTime(2022, 10, 1) };
            arrData[5] = new ServieNotificationLog { Id = 6, ServieNotificationId = 6, Message = "عزيزي المستفيد نفيدكم بأنه تم رفض طلبكم رقم (رقم الطلب) ويمكنكم الاطلاع على سبب الرفض من شاشة طلباتي.", CreatedBy = 1, CreatedDate = new DateTime(2022, 10, 1) };
            return arrData;
        }
