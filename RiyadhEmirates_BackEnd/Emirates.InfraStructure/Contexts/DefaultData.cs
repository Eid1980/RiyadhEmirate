...
namespace Emirates.InfraStructure.Contexts
{
    public static class DefaultData
    {
        ...
        public static Service[] Services()
        {
            ...
            arrData[7] = new Service { Id = 8, NameAr = "تملك عقار للأجانب", NameEn = "Realty Ownership For Foreigners", SectorAr = "تملك عقار للأجانب", SectorEn = "تملك عقار للأجانب", DescriptionAr = "تملك عقار للأجانب", DescriptionEn = "تملك عقار للأجانب", RequestLink = "/eservice/foreigners-realty-owner", WorkDays = "10", ImageName = "magnifying-glass.svg", IsActive = true, CreatedBy = 1, CreatedDate = new DateTime(2022, 10, 1) };
