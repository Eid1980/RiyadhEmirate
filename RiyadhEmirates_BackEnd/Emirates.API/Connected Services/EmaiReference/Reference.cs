...
namespace EmaiReference
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="EmaiReference.emailSoap")]
    public interface emailSoap
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/sendEmail", ReplyAction="*")]
        System.Threading.Tasks.Task<EmaiReference.sendEmailResponse> sendEmailAsync(EmaiReference.sendEmailRequest request);
    }
    ...
    public partial class sendEmailRequest
    {
        ...
        public EmaiReference.sendEmailRequestBody Body;
        
        public sendEmailRequest()
        {
        }
        
        public sendEmailRequest(EmaiReference.sendEmailRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class sendEmailResponse
    {
        ...
        public EmaiReference.sendEmailResponseBody Body;
        
        public sendEmailResponse()
        {
        }
        
        public sendEmailResponse(EmaiReference.sendEmailResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface emailSoapChannel : EmaiReference.emailSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class emailSoapClient : System.ServiceModel.ClientBase<EmaiReference.emailSoap>, EmaiReference.emailSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<EmaiReference.sendEmailResponse> EmaiReference.emailSoap.sendEmailAsync(EmaiReference.sendEmailRequest request)
        {
            return base.Channel.sendEmailAsync(request);
        }
        
        public System.Threading.Tasks.Task<EmaiReference.sendEmailResponse> sendEmailAsync(string subject, string message, string to)
        {
            EmaiReference.sendEmailRequest inValue = new EmaiReference.sendEmailRequest();
            inValue.Body = new EmaiReference.sendEmailRequestBody();
            inValue.Body.subject = subject;
            inValue.Body.message = message;
            inValue.Body.to = to;
            return ((EmaiReference.emailSoap)(this)).sendEmailAsync(inValue);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.emailSoap))
            {
                return new System.ServiceModel.EndpointAddress("http://new.riyadh.gov.sa:7778/email.asmx");
            }
            if ((endpointConfiguration == EndpointConfiguration.emailSoap12))
            {
                return new System.ServiceModel.EndpointAddress("http://new.riyadh.gov.sa:7778/email.asmx");
